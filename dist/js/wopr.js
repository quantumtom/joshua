...
this.g=function(){return this.controls.h[this.controls.h.selectedIndex].value};this.i=function(a){this.startTime=a};this.A=function(){return"http://www.ssd.noaa.gov/"+a.g()+"/img/"+(b()+a.s()+".jpg")};this.w=function(){var b=[],c=a.startTime,e;for(e=0;15>e;e+=1)b.push(a.A()),c.setUTCMinutes(c.getUTCMinutes()+30),a.i(c),console.log(typeof b),console.dir(b);console.dir(typeof b);return b}};a.c=function(){var b=new Date,d;this.l=function(){a.c()};b.setUTCHours(b.getUTCHours()-1);a.i(b);for(d in a.controls)a.controls.hasOwnProperty(d)&&
a.controls[d].addEventListener("change",this.l.bind(this),!1);a.m()};a.m=function(){for(var b,d=a.w(),c;a.display.firstChild;)a.display.removeChild(a.display.firstChild);for(c=0;c<d.length;c+=1)b=document.createElement("img"),b.src=d[c],b.setAttribute("alt","Image #"+(c+1).a(2)),b.classList.add("frame"),b.classList.add("hidden"),a.display.appendChild(b)};a.b=function(b){var d=document.getElementsByClassName("frame");b&&null!==b||(b=0);setTimeout(function(){d.item(b).classList.add("hidden");b=b<d.length-
1?b+1:0;d.item(b).classList.remove("hidden");a.b(b)},a.interval)};a.call()})();}).call(window);
